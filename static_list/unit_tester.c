...
inicializar_uma_lista_com_content_size_negativo_retorna_NULL(void) {
    ...
    static_list_t list = static_list_sequence(-1, 0);
    assert( list == NULL);
...
inicializar_uma_lista_com_sequence_length_negativo_retorna_NULL(void) {
    ...
    static_list_t list = static_list_sequence(1,-1);
    assert( list == NULL);
    static_list_destroy(&list);
}
...
comparar_uma_lista_com_ela_mesma_retorna_1(void) {
    ...
    static_list_t list = static_list_sequence(5, 3);
...
comparar_duas_listas_vazias_retorna_1(void) {
    ...
    static_list_t xs = static_list_sequence(5, 0);
    static_list_t ys = static_list_sequence(5, 0);
...
comparar_duas_listas_iguais_retorna_1(void) {
    ...
    static_list_t xs = static_list_sequence(5, 3);
    static_list_t ys = static_list_sequence(5, 3);
    assert(static_list_compare(xs, ys) == 1);
    static_list_destroy(&xs);
    static_list_destroy(&ys);
}
...
comparar_duas_listas_diferentes_retorna_0(void) {
    ...
    static_list_t xs = static_list_sequence(5, 3);
    static_list_t ys = static_list_sequence(5, 4);
...
printing_an_empty_list(void) {
    ...
    static_list_t list = static_list_sequence(5, 0);
...
printing_an_full_list(void) {
    ...
    static_list_t list = static_list_sequence(5, 5);
    static_list_println(list);
    static_list_destroy(&list);
}
...
printing_some_list(void) {
    ...
    static_list_t list = static_list_init(5, 3, itens);
    static_list_println(list);
    static_list_destroy(&list);
}
...
criar_uma_lista_de_tamanho_0_retorna_NULL(void) {
    ...
    static_list_t list = static_list_create(0);
    assert(list == NULL);
    static_list_destroy(&list);
}
...
criar_uma_lista_de_tamanho_negativo_retorna_NULL(void) {
    ...
    static_list_t list = static_list_create(-5);
    assert(list == NULL);
    static_list_destroy(&list);
}
...
uma_lista_nao_cheia_retorna_0(void) {
    ...
    static_list_t list = static_list_sequence(5, 4);
...
inserir_um_item_em_uma_lista_vazia_altera_para_uma_lista_com_um_item(void) {
    ...
    static_list_t list = static_list_sequence(5, 0);
    static_list_t answer = static_list_sequence(1,1);
...
inserir_3_na_lista_1_2_altera_a_lista_para_1_2_3(void) {
    ...
    static_list_t list = static_list_sequence(5, 2);
    static_list_t answer = static_list_sequence(3,3);
...
inserir_2_na_posicao_1_da_lista_1_3_4_altera_a_lista_para_1_2_3_4(void) {
    ...
    static_list_t list         = static_list_init(4, 3, itens);
    static_list_t correct_list = static_list_sequence(4, 4);
...
localizar_o_item_1_na_lista_1_2_3_retorna_1_e_a_posicao_0(void) {
    ...
    static_list_t list = static_list_sequence(3, 3);
...
deletar_o_item_na_primeira_posicao_da_lista_1_2_3_altera_a_lista_para_2_3(void) {
    ...
    const int itens[] = { 2, 3 };
    static_list_t list = static_list_sequence(3, 3);
    static_list_t answer = static_list_init(2, 2, itens);
